...
export default class Grid extends Component {
        ...
        return (
          <View key={i} style={{ height: 0, flexDirection: 'row' }}>
            {row.map((cell, j) => {
              var color = 'white';
              return (
                <TouchableOpacity key={j} onPress={() => this.changeColor(i, j, 'blue')}>
    ...
    return (
      <View style={{ flexDirection: 'row', justifyContent: 'space-around', padding: 10 }}>
        <TouchableOpacity onPress={() => this.shiftCells('left')}>
          <Image style={styles.img} source={require('../TetrisAssets/left-filled.png')} />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => this.shiftCells('right')}>
          <Image style={styles.img} source={require('../TetrisAssets/right-filled.png')} />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => this.down()}>
          <Image style={styles.img} source={require('../TetrisAssets/down_arrow.png')} />
        </TouchableOpacity>

        <TouchableOpacity onPress={() => this.rotate()}>
          <Image style={styles.img} source={require('../TetrisAssets/rotate_arrow.png')} />
        </TouchableOpacity>
      </View>
    );
  }
  ...
  renderStart() {
    return (
      <Modal animationType={'slide'} transparent={true} visible={this.state.gameOver} style={{ flex: 1 }}>
    ...
    return (
      <View style={{ flex: 1, justifyContent: 'space-around' }}>
        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
          <Text style={{ paddingTop: 10, fontSize: 16, color: 'white' }}>Score: {this.state.score}</Text>
        </View>
        <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
          <View style={{ backgroundColor: 'white' }}>{this.renderCells()}</View>
